...
public class FragmentUtils implements RadioGroup.OnCheckedChangeListener {
    ...
    public FragmentUtils(FragmentManager fragmentManager, List<Fragment> fragments, int fragmentContentId, RadioGroup rgs,SlidingMenu slidingMenu, OnRgsExtraCheckedChangedListener onRgsExtraCheckedChangedListener) {
...
//        this(fragmentManager, fragments, fragmentContentId, rgs, slidingMenu,null);
//    }
